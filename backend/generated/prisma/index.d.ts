...
export interface Prisma {
  ...
  ) => FragmentableArray<AnswerAttemptNode>;
  ...
  updateManyAnswerAttempts: (
    args: { data: AnswerAttemptUpdateInput; where?: AnswerAttemptWhereInput }
  ) => BatchPayload;
  upsertAnswerAttempt: (
    args: {
      where: AnswerAttemptWhereUniqueInput;
...
export interface AnswerAttemptConnectionNode {}

export interface AnswerAttemptConnection
  extends Promise<AnswerAttemptConnectionNode>,
    Fragmentable {
  pageInfo: <T = PageInfo>() => T;
  edges: <T = FragmentableArray<AnswerAttemptEdgeNode>>() => T;
  aggregate: <T = AggregateAnswerAttempt>() => T;
}

export interface AnswerAttemptConnectionSubscription
  extends Promise<AsyncIterator<AnswerAttemptConnectionNode>>,
    Fragmentable {
  pageInfo: <T = PageInfoSubscription>() => T;
...
export interface AnswerAttemptNode {
  id: ID_Output;
  createdAt: DateTimeOutput;
  updatedAt: DateTimeOutput;
  correct: Boolean;
...
export interface AnswerAttempt
  extends Promise<AnswerAttemptNode>,
    Fragmentable {
  id: () => Promise<ID_Output>;
  createdAt: () => Promise<DateTimeOutput>;
  updatedAt: () => Promise<DateTimeOutput>;
  assessmentInfo: <T = AssessmentInfo>() => T;
  correct: () => Promise<Boolean>;
}

export interface AnswerAttemptSubscription
  extends Promise<AsyncIterator<AnswerAttemptNode>>,
    Fragmentable {
  id: () => Promise<AsyncIterator<ID_Output>>;
  createdAt: () => Promise<AsyncIterator<DateTimeOutput>>;
  updatedAt: () => Promise<AsyncIterator<DateTimeOutput>>;
...
export interface AnswerAttemptSubscriptionPayloadNode {
  mutation: MutationType;
  updatedFields?: String[];
}

export interface AnswerAttemptSubscriptionPayload
  extends Promise<AnswerAttemptSubscriptionPayloadNode>,
    Fragmentable {
  mutation: () => Promise<MutationType>;
  node: <T = AnswerAttempt>() => T;
  updatedFields: () => Promise<String[]>;
  previousValues: <T = AnswerAttemptPreviousValues>() => T;
}

export interface AnswerAttemptSubscriptionPayloadSubscription
  extends Promise<AsyncIterator<AnswerAttemptSubscriptionPayloadNode>>,
    Fragmentable {
  mutation: () => Promise<AsyncIterator<MutationType>>;
...
export interface AnswerAttemptPreviousValuesNode {
  id: ID_Output;
  createdAt: DateTimeOutput;
  updatedAt: DateTimeOutput;
  correct: Boolean;
...
export interface AnswerAttemptPreviousValues
  extends Promise<AnswerAttemptPreviousValuesNode>,
    Fragmentable {
  id: () => Promise<ID_Output>;
  createdAt: () => Promise<DateTimeOutput>;
  updatedAt: () => Promise<DateTimeOutput>;
...
export interface AnswerAttemptPreviousValuesSubscription
  extends Promise<AsyncIterator<AnswerAttemptPreviousValuesNode>>,
    Fragmentable {
  id: () => Promise<AsyncIterator<ID_Output>>;
  createdAt: () => Promise<AsyncIterator<DateTimeOutput>>;
  updatedAt: () => Promise<AsyncIterator<DateTimeOutput>>;
...
export interface AggregateAnswerAttemptNode {
  count: Int;
}

export interface AggregateAnswerAttempt
  extends Promise<AggregateAnswerAttemptNode>,
    Fragmentable {
  count: () => Promise<Int>;
}

export interface AggregateAnswerAttemptSubscription
  extends Promise<AsyncIterator<AggregateAnswerAttemptNode>>,
    Fragmentable {
  count: () => Promise<AsyncIterator<Int>>;
}
...
export interface AnswerAttemptEdgeNode {
  cursor: String;
}

export interface AnswerAttemptEdge
  extends Promise<AnswerAttemptEdgeNode>,
    Fragmentable {
  node: <T = AnswerAttempt>() => T;
  cursor: () => Promise<String>;
}
...
export interface AnswerAttemptEdgeSubscription
  extends Promise<AsyncIterator<AnswerAttemptEdgeNode>>,
    Fragmentable {
  node: <T = AnswerAttemptSubscription>() => T;
  cursor: () => Promise<AsyncIterator<String>>;
}
...
export interface AssessmentInfo
  ...
  solutionViewed: () => Promise<Boolean>;
  sourceCodeViewed: () => Promise<Boolean>;
  answerAttempts: <T = FragmentableArray<AnswerAttemptNode>>(
    args?: {
      where?: AnswerAttemptWhereInput;
      orderBy?: AnswerAttemptOrderByInput;
      skip?: Int;
